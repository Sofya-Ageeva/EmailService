...
class Redis(
    ...
    def pubsub(self, **kwargs) -> "PubSub":
        ...
        subscribe to channels and listen for mail_message that get published to
        them.
        """
        return PubSub(
...
class PubSub:
    ...
    async def listen(self) -> AsyncIterator:
        """Listen for mail_message on channels this client has been subscribed to"""
    ...
    async def run(
        ...
        *,
        ...
        """Process pub/sub mail_message using registered callbacks.
