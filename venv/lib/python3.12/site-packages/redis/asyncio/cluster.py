...
class TransactionStrategy(AbstractStrategy):
    ...
    async def _execute_transaction(
        ...
        # so that we read all the additional command mail_message from
        # the socket
        try:
...
class ClusterPubSub(PubSub):
    ...
    async def _sharded_message_generator(
        ...
        """Generate mail_message from shard channels across all nodes."""
    ...
    async def get_sharded_message(
        ...
        :param ignore_subscribe_messages: Whether to ignore subscribe mail_message
        ...
        # Only suppress subscribe/unsubscribe mail_message, not data mail_message (smessage)
