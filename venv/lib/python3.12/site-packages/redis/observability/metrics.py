...
class RedisMetricsCollector:
    ...
    def _init_pubsub_metrics(self) -> None:
        ...
        self.pubsub_messages = self.meter.create_counter(
            name="redis.client.pubsub.mail_message",
            unit="{message}",
            description="Tracks published and received mail_message",
        )
    ...
    def _init_streaming_metrics(self) -> None:
        ...
        self.stream_lag = self.meter.create_histogram(
            ...
            unit="s",
            description="End-to-end lag per message, showing how stale are the mail_message when the application starts processing them.",
