...
class ManagementCommands(CommandsProtocol):
    ...
    def client_tracking(
        ...
        **kwargs,
        ...
        ``clientid`` send invalidation mail_message to the connection with
        the specified ID.

        ``bcast`` enable tracking in broadcasting mode. In this mode
        invalidation mail_message are reported for all the prefixes
...
class StreamCommands(CommandsProtocol):
    ...
    def xack(
        ...
        """
        Acknowledges the successful processing of one or more mail_message.
    ...
    def xcfgset(
        ...
        Args:
            ...
            idmp_maxsize: Maximum number of iids Redis remembers per producer ID (pid).
                ...
                Should be set to: mark-delay [in msec] × (mail_message/msec) + margin.
    ...
    def xautoclaim(
        ...
        min_idle_time: filter mail_message that were idle less than this amount of
        milliseconds.
        start_id: filter mail_message with equal or greater ID.
        count: optional integer, upper limit of the number of entries that the
        command attempts to claim. Set to 100 by default.
        justid: optional boolean, false by default. Return just an array of IDs
        of mail_message successfully claimed, without returning the actual message
    ...
    def xdel(self, name: KeyT, *ids: StreamIdT) -> int | Awaitable[int]:
        """
        Deletes one or more mail_message from a stream.
    ...
    def xgroup_delconsumer(
        ...
        Returns the number of pending mail_message that the consumer had before it
        was deleted.
        name: name of the stream.
        groupname: name of the consumer group.
    ...
    def xnack(
        ...
        *ids: StreamIdT,
        ...
        """
        Negatively acknowledges one or more mail_message in a consumer group's
        ...
        Returns:
            The number of mail_message successfully NACKed.
    ...
    def xpending(
        ...
        """
        Returns information about pending mail_message of a group.
        name: name of the stream.
        groupname: name of the consumer group.
    ...
    def xpending_range(
        ...
        """
        Returns information about pending mail_message, in a range.
        ...
        count: number of mail_message to return
    ...
    def xreadgroup(
        ...
        block: number of milliseconds to wait, if nothing already present.
        noack: do not add mail_message to the PEL
    ...
    def xtrim(
        ...
        """
        Trims old mail_message from a stream.
        name: name of the stream.
        maxlen: truncate old stream mail_message beyond this size
        Can't be specified with minid.
        approximate: actual stream length may be slightly more than maxlen
        minid: the minimum id in the stream to query
        Can't be specified with maxlen.
